                        ...
                        <div class="card-body">
                            <form action="checkout" method="post">
                                <div class="form-group">
                                    ...
                                    <input id="nameOrder" type="text" name="name" class="form-control" placeholder="Enter name" required>
                                    <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small>
                                </div>
                                <div class="form-group">
                                    <label for="sdt">Phone number</label>
                                    <input id="sdt" type="number" name="mobile" class="form-control" placeholder="enter phone number" required>
                                </div>
                                <div class="form-group">
                                    <label for="addressOrder">Address</label>
                                    <textarea  id="addressOrder" class="form-control" rows="3" name="address" required></textarea>
